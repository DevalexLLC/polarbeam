...
var routeDispositions = map[string]string{
	...
	"GET /api/v1/settings/syslog":                          "admin",
	"PUT /api/v1/settings/syslog":                          "admin",
	"POST /api/v1/settings/syslog/test":                    "admin",
...
func TestScopedReadsPassScope(t *testing.T) {
	reads := []struct {
		...
		{"/api/v1/config/targets?q=edge", "QueryTargetsConfig"},
		{"/api/v1/config/targets/edge", "GetTargetConfig"},
		{"/api/v1/targets", "QueryOperationalTargets"},
		{"/api/v1/config/meshes", "ListMeshGroups"},
		{"/api/v1/config/probes", "ListProbeConfigs"},
		{"/api/v1/config/probes?q=icmp", "QueryProbeConfigs"},
		{"/api/v1/config/probes/" + uuid.NewString(), "GetProbeConfigScoped"},
		{"/api/v1/config/networks", "ListNetworksConfig"},
		{"/api/v1/config/sites", "ListSitesConfig"},
		{"/api/v1/config/sites?q=lon", "QuerySitesConfig"},
		{"/api/v1/config/sites/lon", "GetSiteConfig"},
	}
